...
const FeatureCard = memo(({ feature, index, iconType }) => {
  ...
  const IconComponent = iconType
    ? icons[iconType]
    : icons[Object.keys(icons)[index % Object.keys(icons).length]];
...
const BenefitCard = memo(({ benefit, index }) => {
  ...
  return (
    ...
    >
      ...
      <div
        className={`absolute top-0 left-0 right-0 h-1 bg-gradient-to-r ${bgColor} transform origin-left transition-transform duration-300 group-hover:scale-x-100`}
      ></div>

      <div className="flex items-center gap-3">
        <div
          className={`flex-shrink-0 w-8 h-8 rounded-lg bg-gradient-to-r ${bgColor} flex items-center justify-center shadow-md`}
        >
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex-grow">
          ...
          <p className="text-xs text-slate-500 mt-0.5 line-clamp-1">
            {product.shortDescription || "Optimize your healthcare operations"}
          </p>
        </div>
        <motion.div
        ...
        >
                ...
                <div className="mb-8 sm:mb-10">
                  ...
                  <p className="text-slate-600 leading-relaxed">
                    {activeProduct?.description ||
                      `Our innovative ${activeProduct?.title} delivers exceptional value by optimizing healthcare operations and improving outcomes for all stakeholders.`}
                  </p>
                </div>
          ...
          >
            ...
            <p className="mt-4 text-slate-600 max-w-2xl mx-auto">
              Our suite of products works seamlessly together to create an
              integrated solution that addresses your organization's unique
              challenges.
            </p>
